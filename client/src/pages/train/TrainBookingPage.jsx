...
const TrainBookingPage = ({ userDetails, data, setUserDetails, setData }) => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3001/train/getTrain", requestOptions)
  ...
  console.log(data, "the data route");
  return (
